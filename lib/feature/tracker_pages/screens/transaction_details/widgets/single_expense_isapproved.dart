...
class TSingleExpenseCard extends StatelessWidget {
  const TSingleExpenseCard({
    super.key,
    required this.title,
    ...
    return Column(
      children: [
        TRoundedContainer(
          ...
          backgroundColor: approvedInvoice
              ? const Color.fromARGB(255, 139, 249, 229).withOpacity(0.5)
              : const Color.fromARGB(255, 255, 172, 172).withOpacity(0.5),
          borderColor:
